...
- [ ] 实现 `llstk app list`，扫描 `.locallab/app.*/llstk.yml`。
...
```text
created .locallab/app.gitea/llstk.yml
created .locallab/app.gitea/docker-compose.yml
created .locallab/app.gitea/.env
created .locallab/app.gitea/data/gitea/
created .locallab/app.gitea/data/postgres/
```
...
并且 `.locallab/app.gitea/llstk.yml` 能被程序读回和校验。
